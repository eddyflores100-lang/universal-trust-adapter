...
export type EvidenceType = 'sentinel-audit' | 'static-analysis' | 'sandbox-test' | 'human-review' | 'on-chain-verification' | 'tee-attestation' | 'owasp-mcp-scan' | 'runtime-observation';
...
export type ProvenanceSource = 'marketnow' | 'claude' | 'mcp-registry' | 'a2a-network' | 'self-signed' | 'external';
export type NativeFormat = 'atc-v2' | 'atc-v3' | 'eat-ai' | 'zta' | 'a2a-card' | 'mcp-card' | 'w3c-vc' | 'oauth-token' | 'spiffe-svid';
...
export interface IssueInput {
    subject: UTSSubject;
    identity?: UTSIdentity;
    trust: Omit<UTSTrust, 'assessed_at'> & {
        assessed_at?: string;
    };
    capabilities?: UTSCapabilities;
    policy?: UTSPolicy;
