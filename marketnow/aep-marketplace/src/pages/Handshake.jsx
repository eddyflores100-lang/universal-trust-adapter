...
const CONTENT = {
  en: {
    ...
    workflowSteps: [
      ...
      { step: '4', title: 'Purchase', desc: 'One-time free' },
    ...
    pricingDescPost: '.',
    pricingTiers: [
      { price: 'Free', label: 'Utility', desc: 'Single-function MCP servers' },
  ...
  es: {
    ...
    workflowSteps: [
      ...
      { step: '4', title: 'Comprar', desc: 'Pago único free' },
    ...
    pricingDescPost: '.',
    pricingTiers: [
      { price: 'Free', label: 'Utilidad', desc: 'MCP servers de función única' },
  ...
  pt: {
    ...
    workflowSteps: [
      ...
      { step: '4', title: 'Comprar', desc: 'Pagamento único free' },
      { step: '5', title: 'Instalar', desc: 'npx -y @marketnow/install <slug>' },
    ],
    mcpServerTitle: 'MarketNow MCP Server',
    ...
    pricingDescPost: '.',
    pricingTiers: [
      { price: 'Free', label: 'Utilitário', desc: 'MCP servers de função única' },
  ...
  fr: {
    ...
    workflowSteps: [
      ...
      { step: '4', title: 'Acheter', desc: 'Paiement unique free' },
